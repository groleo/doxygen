...
class Sqlite2Jsonml:
	...
	def sql2jsonml(self):
		...
		out_root = ["doxygen", {"version": "1.9.4", "xml:lang":"en-US"}]
		r=[]
		prot_tbl = ['public']
	...
	def xml2jsonml(self):
		...
		with open(ref_jsonml, "w") as f:
			...
			result = self.__xsltproc('xml-to-jsonml.xsl', f_xml)
...
class Tester:
	...
	def perform_test(self,testmgr):
		...
		if failed_warn or failed_xml or failed_html or failed_latex or failed_docbook or failed_rtf or failed_xmlxsd or failed_sqlite3:
